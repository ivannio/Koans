...
namespace DotNetCoreKoans.Koans
{
    public class AboutArrays : Koan
    {
        ...
        public void PushingAndPopping()
        {
            ...
            stack.Push("last");
            object array2 = new object[] { "last", 2, 1 };
            Assert.Equal(array2, stack.ToArray());
            var poppedValue = stack.Pop();
            object array3 = new object[] { 2, 1 };            
        ...
        public void Shifting()
        {
            ...
            var array01 = new[] { "Say", "Hello", "World" };
            var array02 = new[] { "Say", "Hello" };
            var array03 = new[] { "Hello" };

            list.AddFirst("Say");
            Assert.Equal(array01, list.ToArray());

            list.RemoveLast();
            Assert.Equal(array02, list.ToArray());

            list.RemoveFirst();
            Assert.Equal(array03, list.ToArray());
